                   ...
                   <div class="card-header text-center">
                    ...
                    <div class="text-left ml-3 mt-3"><h2>Description :</h2></div>
                        ...
                        <div class="card-footer text-center">
                                 <p style="font-size:35px"><span style="font-size:35px;"><b>Price :</b></span><span class="ml-2"><b>LKR <%=Helper.getProductSellingPrice(product.getProductPrice(), product.getProductDiscount()) %>/-</b></span>
                                 <span class="ml-2" style="font-size:30px;color:red"><s>LKR <%=product.getProductPrice()%></s></span>
                 ...
                 <div class="col-md-12 admin">
                     <div class="card-columns">
                         ...
                         <div class="card">
                             ...
                             <div class="card-footer text-center">
                                 <p style="font-size:25px"><span class="ml-2"><b>LKR <%=Helper.getProductSellingPrice(p.getProductPrice(), p.getProductDiscount()) %>/-</b></span>
                                  <span class="ml-2" style="font-size:20px;color:red"><s>LKR <%=p.getProductPrice()%></s></span>
