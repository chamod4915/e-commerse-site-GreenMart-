...
<nav class="navbar navbar-expand-lg navbar-dark custom-bg">
	...
	<div class="container-fluid">
        ...
        <img src="images/pngegg.png" alt="Green Mart Logo" width="45" height="45">
        <h3 class="d-inline-block ml-2 mb-0">
            <i>Green Mart</i>
        </h3>
    </a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link"
					href="admin.jsp"><b>Admin Page</b> <span class="sr-only">(current)</span></a>
				</li>
				<%
				}
				}
				...
				<li class="nav-item active dropdown"><a
					...
					aria-expanded="false"> <b> Categories</b>
				</a>
			...
			<form class="form-inline my-2 my-lg-0"
				...
				<input type="hidden" name="action" value="searchProduct"> <input
					class="form-control mr-sm-2" type="text"
					placeholder="Search product" aria-label="Search" size="40"
					name="search">
				<button type="submit" class="btn btn-light" style="color: #13C91B">
					<b>Search</b>
				</button>
			</form>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item active" data-toggle="modal"
					...
					<div class="nav-link">
						<img src="images/cart.png" style="width: 23px;" alt="img">(<%=new CartDaoImp().totalCartByUserId(user.getUserId())%>)
					</div>
				</li>

				<li class="nav-item active" data-toggle="modal"
					data-target="#showmyordermodal"><a class="nav-link" href="#"><b>My
							Orders</b></a></li>
				<%
				}
				%>
			...
			<div class="modal-body">
						...
						<tbody>
							...
							<tr class="text-center">
								...
								<td class="mid-align"><a
									href="CartServlet?cartId=<%=c.getCartId()%>&action=delete"><button
				...
				<div class="text-right">
					<p style="font-size: 25px;">
						<b>Total Price :LKR <%=new CartDaoImp().totalPriceFromCart(user.getUserId())%>/-
						</b>
					</p>
				</div>
				<hr>
...
<div class="modal fade" id="showmyordermodal" tabindex="-1"
	role="dialog" aria-labelledby="exampleModalLongTitle"
	aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
						...
						<tbody>
							...
							<tr class="text-center">
								...
								<td class="mid-align">
									...
									%><span
									style="color: red;"> <%="processing.."%></span> <%
 } else {
 %> <%=o.getDeliveryDate()%>
									<%
									}
					...
					<div class="text-right">
						<p style="font-size: 25px;">
							<b>Total Price :LKR <%=new OrderDaoImp().totalOrderPrice(user.getUserId())%>/-
							</b>
						</p>
					</div>
					<hr>
			...
			<div class="modal-body">
				<div class="container">
					<p style="font-size: 20px;">
						<b> At Green Supermarket, we're more than just a store - we're
							a community dedicated to promoting sustainability and healthy
							living. Our shelves are filled with carefully curated products,
							sourced responsibly to ensure the highest quality while
							minimizing our environmental impact. From locally grown produce
							to eco-friendly household essentials, every item reflects our
							commitment to a greener future. We strive to empower our
							customers by providing knowledge and options that support their
							journey towards a more sustainable lifestyle. At Green
							Supermarket, we believe that small choices make a big difference,
							and we're here to make those choices easier for you.
			...
			<div class="modal-body">
				<div class="container text-center">
					<p style="font-size: 23px;">
						<b> <img src="images/phone.png" style="width: 27px;" alt="img">077 4915064 / 077 3515314<br> <img src="images/mail.png"
							style="width: 29px;" alt="img">chamodthilinakumara9@gmail.com
						</b>
					</p>
				</div>
			</div>
